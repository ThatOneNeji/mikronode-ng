...
const connection = new MikroNode.Connection(process.argv[2], process.argv[3], process.argv[4], {
    closeOnDone: true
});
 ...
 */
const connPromise = connection.getConnectPromise().then(function resolve(conn) {
